...
Gem::Specification.new do |s|
  ...
  s.add_dependency "activesupport", ">= 3.2.0", "<= 4.2.0.beta4"
  s.add_dependency "i18n", "~> 0.6"

  s.add_development_dependency "actionpack", ">= 3.2.0", "<= 4.2.0.beta4"
  s.add_development_dependency "activerecord", ">= 3.2.0", "<= 4.2.0.beta4"
